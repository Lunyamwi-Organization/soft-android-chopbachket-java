...
public class SettingsActivity extends AppCompatActivity {
    ...
    //get the image that has been cropped using onActivity result
    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if (requestCode==CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE  &&  resultCode==RESULT_OK  &&  data!=null)
        {
            ...
            //display the image on the profile picture field
    ...
    private void userInfoSaved() {
        ...
        {
            Toast.makeText(this, "Delivery Address Cannot Be Empty", Toast.LENGTH_SHORT).show();
        }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task)
                        {
                            if (task.isSuccessful())
                            {
                                ...
                                DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("Users");
                                //HasMap used because we have a lot of data
                                HashMap<String, Object> userMap = new HashMap<>();
                                userMap. put("name", fullNameEditText.getText().toString());
                                userMap. put("address", addressEditText.getText().toString());
                                userMap. put("phoneOrder", userPhoneEditText.getText().toString());
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    if (dataSnapshot.child("image").exists())
                    {
                        ...
                        Picasso.get().load(image).into(profileImageView);//displays image
